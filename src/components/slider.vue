      ...
      <!-- 无缝滚动 -->
       <template  v-if="sliderinit.loop">
         <template v-if="sliderinit.infinite" v-for="(item, index) in pages" >
            <div v-if="index+sliderinit.infinite-pages.length>=0" class="slider-item">{{item.title}}</div>
         </template>
         <template v-if="!sliderinit.infinite">
            <div class="slider-item">
              <img :src="'http://static.shanpa98.com/thumb/640/'+pages[pages.length-1].icon" width="100%" class="list-pic">
            </div>
         </template>
         <!-- 无缝滚动copy最后项 -->
         <template  v-for="item in pages">
         ...
         <!-- 无缝滚动copy第一项 -->
         <template v-if="sliderinit.infinite" v-for="(item, index) in pages" >
            <div v-if="index-sliderinit.infinite<0" class="slider-item">
              <img :src="'http://static.shanpa98.com/thumb/640/'+item.icon" width="100%">
            </div>
         </template>
         <template v-if="!sliderinit.infinite">
            <div class="slider-item">
              <img :src="'http://static.shanpa98.com/thumb/640/'+pages[0].icon" width="100%">
            </div>
         </template>
       </template>
      </div>
